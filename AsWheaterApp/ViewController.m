...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  DetailedViewController *detailedViewController=[story instantiateViewControllerWithIdentifier:@"  DetailedViewController"];
    ForecastTableViewCell *cell=[tableView cellForRowAtIndexPath:indexPath];
    
    detailedViewController.strDay=cell.lblDay.text;
    detailedViewController.strMin=cell.lblMax.text;
    detailedViewController.strMax=cell.lblMin.text;
    detailedViewController.isCurrent=NO;
...
- (IBAction)goToNext:(id)sender {
    ...
    UIStoryboard *story=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
   DetailedViewController *detailedViewController=[story instantiateViewControllerWithIdentifier:@"DetailedViewController"];
    detailedViewController.isCurrent=YES;
    [self.navigationController pushViewController:detailedViewController animated:YES];
}
